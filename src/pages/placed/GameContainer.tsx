...
export default function GameContainer({ placeData }: GameContainerProps) {
  ...
  // 문장 풀 생성 (sentence가 없을 경우 기본문장 처리)
        ...
        <>
          ...
          {selectedGame.gameKey === 'picture_quiz' && (
            <PictureQuizModal
              ...
              onWrongAnswer={() => {}} apartmentImg={bgImage}
            />
          )}
