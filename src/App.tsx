...
import ApartmentPage from "@/pages/placed/constants/my-house/houseSubPage/ApartmentPage";
import LivingRoomPage from "@/pages/placed/constants/my-house/houseSubPage/LivingRoomPage";
import KitchenPage from "@/pages/placed/constants/my-house/houseSubPage/KitchenPage";
import BathroomPage from "@/pages/placed/constants/my-house/houseSubPage/BathroomPage";
import BedroomPage from "@/pages/placed/constants/my-house/houseSubPage/BedroomPage";
import PlaygroundPage from "@/pages/placed/constants/my-house/houseSubPage/PlaygroundPage";
import RecyclingPage from "@/pages/placed/constants/my-house/houseSubPage/RecyclingPage";
import CalenderPage from "@/pages/placed/constants/my-house/houseSubPage/CalenderPage";
import FamilyPage from "@/pages/placed/constants/my-house/houseSubPage/FamilyPage";
import HousePage from "@/pages/placed/constants/my-house/houseSubPage/HousePage";
